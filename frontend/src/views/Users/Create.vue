      ...
      <main class="flex-1 flex items-center justify-center overflow-auto">
        <div class="bg-white p-8 rounded shadow w-full max-w-lg text-center">
          ...
          <form @submit.prevent="onSubmit" class="space-y-4">
            <input v-model="username" type="text" placeholder="Username" class="w-full px-4 py-2 border rounded" required />
            <input v-model="email" type="email" placeholder="Email" class="w-full px-4 py-2 border rounded" required />
            <input v-model="first_name" type="text" placeholder="First Name" class="w-full px-4 py-2 border rounded" />
            <input v-model="last_name" type="text" placeholder="Last Name" class="w-full px-4 py-2 border rounded" />
            <input v-model="password" type="password" placeholder="Password" class="w-full px-4 py-2 border rounded" required />
            <select v-model="role" class="w-full px-4 py-2 border rounded" required>
