  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-100 via-white to-purple-100 flex flex-col">
    ...
    <div class="flex flex-1 h-0">
      ...
      <main class="flex-1 flex flex-col items-center justify-center px-6 py-10">
        <h2 class="text-4xl font-extrabold mb-8 text-blue-700 tracking-wide drop-shadow-lg">👥 Users</h2>
        <button
        ...
        <div class="overflow-x-auto w-full max-w-4xl">
          <div class="p-0">
            <div class="table-scroll-area">
              <table class="w-full rounded-2xl overflow-hidden shadow-xl border border-blue-200 bg-white">
                ...
                <tbody>
                  ...
                  <tr v-if="paginatedUsers.length === 0">
                    <td colspan="5" class="py-3 px-4 text-gray-400 bg-gray-50 rounded-lg text-center">No users found.</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div class="flex justify-center items-center gap-2 mt-4">
              ...
              <span class="font-semibold text-blue-700">Page {{ currentPage }} of {{ totalPages }}</span>
              <button
                class="px-3 py-1 rounded bg-blue-200 text-blue-700 hover:bg-blue-300 transition"
